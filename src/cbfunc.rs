#![deprecated(note = "one-off ternary bruteforcer (hardcoded target + DEPTH); superseded by eml_v5_1")]
...
fn main() {
    ...
    let mut progress = cbfunc::open_progress_log("progress.log").unwrap();
